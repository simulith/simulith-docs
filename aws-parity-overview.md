...
18 **available** = **90%** Tier A Cognito (18 / 20). Shipped extras (ListUserPools, UpdateUserPool, UpdateUserPoolClient, AddCustomAttributes, ListUsers, UserPoolDomain, Lambda triggers, Set/Get UserPoolMfaConfig, TagResource / UntagResource / ListTagsForResource) are outside this ref set.
