...
| **Cognito** | 20 | 2 / 2 scenarios | **90%** (18 / 20) | **low subset** |
...
| **Total** | **187** | 17 services with verify | **~98%** Tier A (180 / 184 ref) | — |
...
18 **available** = **90%** Tier A Cognito (18 / 20). Shipped extras (ListUserPools, UpdateUserPool, UserPoolDomain, Lambda triggers, Set/Get UserPoolMfaConfig, TagResource / UntagResource / ListTagsForResource) are outside this ref set.
