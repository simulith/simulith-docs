...
variable "use_simulith_endpoint" {
  description = "When true, route CloudWatch Logs API calls to Simulith; when false, use real AWS"
  type        = bool
  default     = true
}
...
variable "log_group_name" {
  description = "CloudWatch Logs group name (Serverless-style path)"
  type        = string
  default     = "/aws/lambda/demo-tf"
}
