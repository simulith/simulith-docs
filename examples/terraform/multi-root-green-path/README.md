...
See [`runtime/docs/terraform-integration.md`](../../../terraform-integration.md).

**Lambda on Simulith:** use Terraform modules under [`../lambda/`](../lambda/) or [`../lambda-vpc-rds/`](../lambda-vpc-rds/) — not Serverless Framework deploy scripts.
