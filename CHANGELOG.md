...
- ****: Console RDS DB Proxy panel + Lambda Layers date fix
...
- ****: Console Lambda publish layer (AWS parity)

## [0.175.0] - 2026-09-09

### Features

- ****: serverless-simulith npm publish

## [0.174.0] - 2026-09-09

### Features

- ****: Console S3 copy object (AWS Copy parity)

## [0.173.0] - 2026-09-09

### Features

- ****: Console Lambda event source mappings (AWS Triggers parity)

## [0.172.0] - 2026-09-09

### Features

- ****: Console APIGW custom domain names (AWS Domains parity)

## [0.171.0] - 2026-09-09

### Features

- ****: Console Cognito user admin (AWS Users parity)
...
- ****: demoapp full-stack local parity

## [0.169.1] - 2026-09-08

### Fixes

- ****: Lambda ListLayers path without trailing slash
...
- ****: CFN ValidateTemplate operation

## [0.167.3] - 2026-09-08

### Fixes

- ****: Node.js Lambda callback-style handlers
...
- ****: GET V1 base path mappings (domain-manager)
...
- ****: API Gateway custom domains (serverless-domain-manager)
...
- ****: Serverless auth-api T2 deploy parity

## [0.165.0] - 2026-09-07

### Features

- ****: CFN AWS::Lambda::Version type
...
- ****: serverless-simulith deploy depth (auth-api T2)

## [0.162.3] - 2026-09-05

### Fixes

- ****: CFN UpdateStack S3 deployment bucket preservation
...
- ****: S3 virtual-hosted bucket operations
...
- ****: CFN AWS::S3::BucketPolicy type

## [0.160.0] - 2026-09-04

### Features

- ****: CFN AWS::S3::Bucket type
...
- ****: Secrets Manager secret tags

## [0.152.0] - 2026-08-28

### Features

- ****: Production multi-root web Terraform green path
...
- ****: Production multi-root cognito Terraform green path

## [0.146.0] - 2026-08-26

### Features

- ****: Production multi-root ses Terraform green path
...
- ****: Production multi-root postgresdb Terraform green path

## [0.143.0] - 2026-08-25

### Features

- ****: Production multi-root secrets Terraform green path

## [0.142.0] - 2026-08-25

### Features

- ****: Production multi-root Terraform green path

## [0.141.0] - 2026-08-25

### Features

- ****: Vpc root Terraform green path

## [0.140.0] - 2026-08-25

### Features

- ****: Proxydb root Terraform green path
...
- ****: Subnets root Terraform green path

## [0.137.0] - 2026-08-24

### Features

- ****: Secrets root Terraform green path

## [0.136.0] - 2026-08-24

### Features

- ****: SES root Terraform green path

## [0.135.0] - 2026-08-24

### Features

- ****: Parameters root Terraform green path

## [0.134.0] - 2026-08-24

### Features

- ****: Cognito PreSignUp Lambda trigger Terraform
...
- ****: Cognito user pool custom schema
