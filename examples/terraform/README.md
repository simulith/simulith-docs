...
├── cloudwatch-alarms/  ← aws_cloudwatch_metric_alarm apply + destroy
...
| [`cloudwatch-alarms/`](cloudwatch-alarms/) | Green | Green | `aws_cloudwatch_metric_alarm`; `endpoints { cloudwatch }`; `-parallelism=1`; [README](cloudwatch-alarms/README.md) |
