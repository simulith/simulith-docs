...
| [`multi-root-green-path/`](examples/terraform/multi-root-green-path/) | Green | Green | Production chain: bootstrap → **01-vpc** → **02-subnets** → **03-secrets** → **04-postgresdb** via S3 remote state — `-parallelism=1` |
