# T2 manual verify - SML-295 full multi-root chain apply + reverse destroy
$ErrorActionPreference = "Stop"
$Log = Join-Path $PSScriptRoot "t2-sml295.log"
