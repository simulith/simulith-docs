...
| [`multi-root-green-path/`](examples/terraform/multi-root-green-path/) | Green | Green | Production chain: bootstrap → **01-vpc** → **02-subnets** → **03-secrets** → **04-postgresdb** → **05-proxydb** → **06-ses** → **07-cognito** → **08-parameters** via S3 remote state — `-parallelism=1` |
